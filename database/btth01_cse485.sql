...
--
-- Host: localhost:3306
-- Generation Time: Dec 02, 2023 at 06:16 AM
...
CREATE TABLE `baiviet` (
  ...
  `tieude` varchar(200) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
--
ALTER TABLE `baiviet`
  MODIFY `ma_bviet` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tacgia`
--
ALTER TABLE `tacgia`
  MODIFY `ma_tgia` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `theloai`
--
ALTER TABLE `theloai`
  MODIFY `ma_tloai` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
